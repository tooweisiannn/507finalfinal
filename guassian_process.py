...
def GP(strat, df):
    ...
    years = np.arange(2011, 2026).reshape(-1, 1)  # From 2011 to 2023
    ...
    fig.update_layout(title='Gaussian Process Predictions with Confidence Bands', 
                    xaxis_title='Year', yaxis_title='Mentally Unhealthy Days', 
...
#for stratification in gp_data.columns:
#    fig = GP(stratification, gp_data)  # Assuming 'GP' is your function and 'gp_data' your DataFrame
#    filename = f'{stratification}_gp_plot.pickle'
#    save_figure_as_pickle(fig, filename)